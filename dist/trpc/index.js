...
var paymentRouter_1 = require("./paymentRouter");
exports.appRouter = (0, trpc_1.router)({
    auth: authRouter_1.authRouter,
    payment: paymentRouter_1.paymentRouter,
    getInfiniteProducts: trpc_1.publicProcedure
        .input(z.object({
        limit: z.number().min(1).max(100),
        cursor: z.number().nullish(),
        query: schema_1.ProductQuerySchema,
    }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, limit, sort, queryOptions, payload, parsedQueryOptions, page, _b, products, hasNextPage, nextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = input.query, cursor = input.cursor;
                        limit = query.limit, sort = query.sort, queryOptions = __rest(query, ["limit", "sort"]);
